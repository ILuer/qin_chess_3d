...
export const SUBGROUP_JOINTS: Record<string, Record<string, Vec3>> = {
  ...
  //   原 0.378 落在臂盒 [0.414,0.506] 之下 0.036，绕空点公转）。
  // ★ S2b-step2（M-08d2 · 2026-09-22）：A.arms → armR/armL 独立肩关节（§7.3 #1 几何前提）。
  //   枢轴 = 各侧真肩点 = 大臂 strut 起点 a=[±0.140, 0.560, −0.006] 作者 y − FOOT(0.086)
  //   → [±0.140, 0.474, −0.006]；M-06 ④ 的 y=0.474 校准值在两侧肩点中逐位保留。
