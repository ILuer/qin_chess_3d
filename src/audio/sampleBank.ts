...
export const SAMPLE_MANIFEST: Record<string, string> = {
  ...
  /* ---- Foley：Sprint2 真实录音（R/C · Freesound CC0）---- */
  'foley.rook.idle':    'assets/audio/foley/rook.idle.mp3',       // 车·轮轴吱呀（Freesound CC0 #662519）
  'foley.rook.move':    'assets/audio/foley/rook.move.mp3',       // 车·轮滚（Freesound BY #44230）
  'foley.rook.capture': 'assets/audio/foley/rook.capture.mp3',    // 车·急刹/撞击（Freesound BY #429166）
  'foley.cannon.idle':  'assets/audio/foley/cannon.idle.mp3',     // 炮·木架吱呀（Freesound CC0 #151886）
  'foley.cannon.move':  'assets/audio/foley/cannon.move.mp3',     // 炮·推行（Freesound CC0 #406192）
  'foley.cannon.capture':'assets/audio/foley/cannon.capture.mp3', // 炮·巨石落地（Freesound CC0 #369981）
